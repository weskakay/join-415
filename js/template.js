    ...
    <div class="detailsProfile">
      ...
      <div class="detailsName">
        ...
        <div class="detailsEdit">
          ...
          <button
            onclick="deleteContact('login-data/${userLoginKey}/contacts/${contacts[indexContacts].id}')"
          >
            <img
        ...
        <div class="addContactFull">
          ...
          <div class="add-task-bottom-buttons">
            <button
              ...
              onclick="deleteContact('login-data/${userLoginKey}/contacts/${contacts[indexContacts].id}'), d_none('overlayEdit'), clearInput('nameInputEdit', 'mailInputEdit', 'telInputEdit')"
            >
              Delete
            </button>
            <button
